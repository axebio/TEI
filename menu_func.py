...
class menu_funcionarios(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        consultar_button = tk.Button(self, text="CONSULTAR", width= 100, height= 3, command= lambda: controller.show_frame("func_consulta"))
        consultar_button.pack(side = "top", padx= 20, pady= 5)

        cadastrar_button = tk.Button(self, text="CADASTRAR", width= 100, height= 3, command= lambda: controller.show_frame("func_cadastro"))
        cadastrar_button.pack(side = "top", padx= 20, pady= 5)

        excluir_button = tk.Button(self, text="EXCLUIR", width= 100, height= 3, command= lambda: controller.show_frame("func_excluir"))
